package ist.meic.cmu.locmess_client.messages.posted.archived;
...
public class ArchivedTabFragment extends Fragment implements OnRecyclerCardClicked{

    private static List<Message> DUMMY_DATASET;

    MyMessageCardAdapter mAdapter;

    public ArchivedTabFragment() {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null){
            Message[] parcelables = (Message[]) savedInstanceState.getParcelableArray("archived_messages");
            if (parcelables != null) {
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putParcelableArray("archived_messages", DUMMY_DATASET.toArray(new Message[DUMMY_DATASET.size()]));
    }
